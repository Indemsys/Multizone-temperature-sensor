...
__asm void SVC_Handler(void)
{
  ...
  /* Pop the core registers. */
    #if (configCPU_FAMILY==configCPU_FAMILY_ARM_M4F)
  ldmia r0!, /* \todo: r14, check http://sourceforge.net/p/freertos/discussion/382005/thread/a9406af1/?limit=25#3bc7 */
  {r4-r11, r14}
    #else
  ldmia r0!,
  {r4-r11}
...
__asm void SVC_Handler(void)
{
  ...
  ldmia r0!,    /* Pop the high registers. */
  {r4-r7}
  mov r8, r4
  mov r9, r5
  mov r10, r6
...
__asm void PendSV_Handler(void)
{
  ...
  stmdb r0!,   /* save remaining core registers */
  {r4-r11, r14}
    #else
  stmdb r0!,        /* Save the core registers. */
  {r4-r11}
    #endif
  ...
  ldr r0, [r1]
    #if (configCPU_FAMILY==configCPU_FAMILY_ARM_M4F)
  ldmia r0!,   /* Pop the core registers */
  {r4-r11, r14}
...
__asm void PendSV_Handler(void)
{
  ...
  stmia r0!,         /* Store the low registers that are not saved automatically. */
  {r4-r7}
  ...
  bl vTaskSwitchContext
  cpsie i
  pop               /* lr goes in r3. r2 now holds tcb pointer. */
  {r2, r3}
