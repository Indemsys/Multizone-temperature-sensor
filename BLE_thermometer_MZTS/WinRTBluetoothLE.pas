...
type
  ...
  TAdvertisingDataType_description = record
    id: integer;
    descr: string;
  end;
...
const
  ...
  AdvertisingDataTypes: array [0 .. 41] of TAdvertisingDataType_description = ((id: $01; descr: 'Flags'), (id: $02;
    descr: 'Incomplete List of 16-bit Service Class UUIDs'), (id: $03; descr: 'Complete List of 16-bit Service Class UUIDs'), (id: $04;
    descr: 'Incomplete List of 32-bit Service Class UUIDs'), (id: $05; descr: 'Complete List of 32-bit Service Class UUIDs'), (id: $06;
    descr: 'Incomplete List of 128-bit Service Class UUIDs'), (id: $07; descr: 'Complete List of 128-bit Service Class UUIDs'), (id: $08;
    descr: 'Shortened Local Name'), (id: $09; descr: 'Complete Local Name'), (id: $0A; descr: 'Tx Power Level'), (id: $0D; descr: 'Class of Device'), (id: $0E;
    descr: 'Simple Pairing Hash C'), (id: $0F; descr: 'Simple Pairing Randomizer R'), (id: $10; descr: 'Device ID'), (id: $11;
    descr: 'Security Manager Out of Band Flags'), (id: $12; descr: 'Slave Connection Interval Range'), (id: $14;
    descr: 'List of 16-bit Service Solicitation UUIDs'), (id: $15; descr: 'List of 128-bit Service Solicitation UUIDs'), (id: $16;
    descr: 'Service Data - 16-bit UUID'), (id: $17; descr: 'Public Target Address'), (id: $18; descr: 'Random Target Address'), (id: $19; descr: 'Appearance'),
    (id: $1A; descr: 'Advertising Interval'), (id: $1B; descr: 'LE Bluetooth Device Address'), (id: $1C; descr: 'LE Role'), (id: $1D;
    descr: 'Simple Pairing Hash C-256'), (id: $1E; descr: 'Simple Pairing Randomizer R-256'), (id: $1F; descr: 'List of 32-bit Service Solicitation UUIDs'),
    (id: $20; descr: 'Service Data - 32-bit UUID'), (id: $21; descr: 'Service Data - 128-bit UUID'), (id: $22;
    descr: 'LE Secure Connections Confirmation Value'), (id: $23; descr: 'LE Secure Connections Random Value'), (id: $24; descr: 'URI'), (id: $25;
    descr: 'Indoor Positioning'), (id: $26; descr: 'Transport Discovery Data'), (id: $27; descr: 'LE Supported Features'), (id: $28;
    descr: 'Channel Map Update Indication'), (id: $29; descr: 'PB-ADV'), (id: $2A; descr: 'Mesh Message'), (id: $2B; descr: 'Mesh Beacon'), (id: $3D;
    descr: '3D Information Data'), (id: $FF; descr: 'Manufacturer Specific Data'));
...
Type
  ...
  private
    ...
    F_AdvertisingDataTypeDescriptions: array of string;
  protected
  ...
  public
    destructor Destroy; override;
    constructor Create;
    function Get_AdvertisingDataTypeDescription(id: integer): string;
  end;
  ...
  private
    [Weak]
    FAdapter: TWinRTBluetoothLEAdapter;
  ...
  private
    ...
    function GetMaxOutOfRangeTimeout: Int64;
    function GetMaxSamplingInterval: Int64;
    function GetMinOutOfRangeTimeout: Int64;
    function GetMinSamplingInterval: Int64;
    function GetScanningMode: integer;
  protected
    ...
    procedure BLEAdvertisementReceived(const AAdvertisement: IBluetoothLEAdvertisement; const AdvertisementType: BluetoothLEAdvertisementType; AAddress: UInt64;
      ARSSI: SmallInt; const ATimestamp: DateTime);
  ...
  public
    ...
    destructor Destroy; override;
    property MaxOutOfRangeTimeout: Int64 read GetMaxOutOfRangeTimeout;
    property MinOutOfRangeTimeout: Int64 read GetMinOutOfRangeTimeout;
    property MaxSamplingInterval: Int64 read GetMaxSamplingInterval;
    property MinSamplingInterval: Int64 read GetMinSamplingInterval;
    property ScanningMode: integer read GetScanningMode;
  end;
  ...
  TConnectionStatusChangeEventHandler = class(TInspectableObject, TypedEventHandler_2__IBluetoothLEDevice__IInspectable_Delegate_Base,
    TypedEventHandler_2__IBluetoothLEDevice__IInspectable)
  private
    [Weak]
    FDevice: TWinRTBluetoothLEDevice;
  ...
  public
    procedure Set_Last_RSSI(rssi: integer);
    // FLastRSSI: Integer; overload;
  ...
  protected
    ...
    function DoCreateIncludedService(const AService: TBluetoothGattService; const AnUUID: TBluetoothUUID; AType: TBluetoothServiceType)
      : TBluetoothGattService; override;
    { Characteristic Management }
    function DoCreateCharacteristic(const AService: TBluetoothGattService; const AnUUID: TBluetoothUUID; const AProps: TBluetoothPropertyFlags;
    ...
    procedure DoCharacteristicWriteRequest(const ADevice: System.Bluetooth.TBluetoothLEDevice; ARequestId: integer;
      const AGattCharacteristic: TBluetoothGattCharacteristic; APreparedWrite: Boolean; AResponseNeeded: Boolean; AnOffset: integer;
      const AValue: TBytes); override;
  ...
  protected
    ...
    function DoCreateCharacteristic(const AUuid: TBluetoothUUID; APropertyFlags: TBluetoothPropertyFlags; const ADescription: string)
      : TBluetoothGattCharacteristic; override;
    ...
    procedure Close;
  public
    constructor Create(const ADevice: TWinRTBluetoothLEDevice; const AGattService: GenericAttributeProfile_IGattDeviceService; AType: TBluetoothServiceType);
    destructor Destroy; override;
  end;
  ...
  private
    [Weak]
    FGattCharacteristic: TWinRTBluetoothGattCharacteristic;
  ...
  protected
    [Weak]
    FBluetoothGattService: TWinRTBluetoothGattService;
    ...
    function SetClientCharacteristicConfigurationDescriptor(const ADescriptorValue
      : GenericAttributeProfile_GattClientCharacteristicConfigurationDescriptorValue): Boolean;
  public
  ...
  protected
    ...
    function GetUUID: TBluetoothUUID; override;
  public
    constructor Create(const ACharacteristic: TWinRTBluetoothGattCharacteristic; const AGattDescriptor: GenericAttributeProfile_IGattDescriptor);
  end;
...
begin
  Result := Format(SBluetoothMACAddressFormat, [AnAddress.rgBytes[5], AnAddress.rgBytes[4], AnAddress.rgBytes[3], AnAddress.rgBytes[2], AnAddress.rgBytes[1],
    AnAddress.rgBytes[0]]);
end;
...
function TWinRTBluetoothLEManager.Get_AdvertisingDataTypeDescription(id: integer): string;
begin
  Result := F_AdvertisingDataTypeDescriptions[id and $FF];
end;

constructor TWinRTBluetoothLEManager.Create;
var
  I: integer;
  K: integer;
begin
  inherited;
  SetLength(F_AdvertisingDataTypeDescriptions, 256);
  for I := 0 to 255 do
  begin
    F_AdvertisingDataTypeDescriptions[I] := '';
    for K := Low(AdvertisingDataTypes) to High(AdvertisingDataTypes) do
    begin
      if AdvertisingDataTypes[K].id = I then
      begin
        F_AdvertisingDataTypeDescriptions[I] := AdvertisingDataTypes[K].descr;
        break;
      end;
    end;
  end;
...
constructor TWinRTBluetoothLEAdapter.TDiscoverThreadTimer.Create(const AnAdapter: TBluetoothLEAdapter; const AStopDiscoveryProc: TStopDiscoveryProc;
  Timeout: Cardinal);
begin
...
begin
  ...
  (LDevice as TWinRTBluetoothLEDevice).Set_Last_RSSI(ARSSI);
...
begin
  ...
  if TAsyncOperation<IAsyncOperation_1__IVectorView_1__IDeviceInformation>.Wait
    (TDeviceInformation.Statics.FindAllAsync(TBluetoothLEDevice.Statics.GetDeviceSelector), LDeviceInformationCollectionAsyncOp) = AsyncStatus.Completed then
  begin
    ...
    if LBLEDevicesFound.Size > 0 then
      ...
      begin
        LWinBluetoothLEDevice := TWinRTBluetoothLEDevice(TWinRTBluetoothLEManager.GetDeviceInList(Format('%.12x',
          [TWinRTBluetoothLEDevice.AddressFromId(LBLEDevicesFound.GetAt(I).id)]), FManager.AllDiscoveredDevices));
        ...
        begin
          ...
          LWinBluetoothLEDevice := TWinRTBluetoothLEDevice(TWinRTBluetoothLEManager.AddDeviceToList(System.Bluetooth.TBluetoothLEDevice(LWinBluetoothLEDevice),
...
function TWinRTBluetoothLEAdapter.GetMaxOutOfRangeTimeout: Int64;
begin
  result:=FAdvertisementWatcher.MaxOutOfRangeTimeout.Duration;
end;

function TWinRTBluetoothLEAdapter.GetMaxSamplingInterval: Int64;
begin
  result:=FAdvertisementWatcher.MaxSamplingInterval.Duration;
end;

function TWinRTBluetoothLEAdapter.GetMinOutOfRangeTimeout: Int64;
begin
  result:=FAdvertisementWatcher.MinOutOfRangeTimeout.Duration;
end;

function TWinRTBluetoothLEAdapter.GetMinSamplingInterval: Int64;
begin
  result:=FAdvertisementWatcher.MinSamplingInterval.Duration;
end;
...
function TWinRTBluetoothLEAdapter.DoStartDiscoveryRaw(const ABluetoothLEScanFilterList: TBluetoothLEScanFilterList; Refresh: Boolean): Boolean;
begin
  FScannedLEDevices.Clear;
  FBluetoothLEScanFilterList := ABluetoothLEScanFilterList;
  FAdvertisementWatcher.Start;
...
function TWinRTBluetoothLEAdapter.GetScanningMode: integer;
begin
  result := Ord(FAdvertisementWatcher.ScanningMode);
end;
...
procedure TWinRTBluetoothLEAdapter.DoDeviceDiscovered(const ADevice: System.Bluetooth.TBluetoothLEDevice; ANewDevice: Boolean;
...
begin
  ...
  if LConnected and Assigned(OnConnect) then
    OnConnect(Self)
  else if (not LConnected) and Assigned(OnDisconnect) then
    OnDisconnect(Self);
end;

constructor TWinRTBluetoothLEDevice.Create(const AAddress: UInt64; const ALEAdapter: TWinRTBluetoothLEAdapter; AutoConnect: Boolean);
begin
...
constructor TWinRTBluetoothLEDevice.Create(const AId: HSTRING; const ALEAdapter: TWinRTBluetoothLEAdapter; AutoConnect: Boolean);
begin
  inherited Create(AutoConnect);
  FId := AId;
...
begin
  ...
  begin
    if TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_GattCommunicationStatus>.Wait(FReliableWriteTransaction.CommitAsync, LWriteValueAsync)
      = AsyncStatus.Completed then
...
function TWinRTBluetoothLEDevice.DoSetCharacteristicNotification(const ACharacteristic: TBluetoothGattCharacteristic; Enable: Boolean): Boolean;
var
...
begin
  ...
  else if TBluetoothProperty.Indicate in ACharacteristic.Properties then
...
procedure TWinRTBluetoothLEDevice.Set_Last_RSSI(rssi: integer);
begin
  FLastRSSI := rssi;
end;
...
begin
  ...
  begin
    ...
    if TAsyncOperation<IAsyncOperation_1__IBluetoothLEDevice>.Wait(TBluetoothLEDevice.Statics.FromIdAsync(FId), LBLEDeviceAsyncOp) = AsyncStatus.Completed then
    begin
...
function TWinRTBluetoothGattCharacteristic.SetClientCharacteristicConfigurationDescriptor(const ADescriptorValue
  : GenericAttributeProfile_GattClientCharacteristicConfigurationDescriptorValue): Boolean;
var
...
begin
  ...
  else if (TBluetoothProperty.Notify in Properties) or (TBluetoothProperty.Indicate in Properties) then
  begin
    if FGattValueChangedERT.Value <> 0 then
      FGattCharacteristic.remove_ValueChanged(FGattValueChangedERT);
  ...
  if TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_GattCommunicationStatus>.Wait
    (FGattCharacteristic.WriteClientCharacteristicConfigurationDescriptorAsync(ADescriptorValue), LWriteDescValueAsync) = AsyncStatus.Completed then
...
begin
  ...
  begin
    ...
    if TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_GattCommunicationStatus>.Wait(FGattCharacteristic.WriteValueAsync(BytesToIBuffer(FValue),
      LWriteOption), LWriteValueAsync) = AsyncStatus.Completed then
...
begin
  Result := TBluetoothGattStatus.Failure;
  if TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_IGattReadResult>.Wait(FGattCharacteristic.ReadValueAsync(BluetoothCacheMode.Uncached),
...
constructor TWinRTBluetoothGattService.Create(const ADevice: TWinRTBluetoothLEDevice; const AGattService: GenericAttributeProfile_IGattDeviceService;
...
function TWinRTBluetoothGattService.DoCreateCharacteristic(const AUuid: TBluetoothUUID; APropertyFlags: TBluetoothPropertyFlags; const ADescription: string)
...
begin
  ...
  Result := TBluetoothUUIDHelper.FromShortId(LValue);
end;
...
begin
  Result := TBluetoothGattStatus.Failure;
  if (TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_GattCommunicationStatus>.Wait(FGattDescriptor.WriteValueAsync(BytesToIBuffer(FValue)),
    LWriteValueAsync) = AsyncStatus.Completed) and (LWriteValueAsync.GetResults = GenericAttributeProfile_GattCommunicationStatus.Success) then
    Result := TBluetoothGattStatus.Success;
end;
...
begin
  Result := TBluetoothGattStatus.Success;
  if TAsyncOperation<IAsyncOperation_1__GenericAttributeProfile_IGattReadResult>.Wait(FGattDescriptor.ReadValueAsync(BluetoothCacheMode.Uncached),
    LGattReadValueAsyncOp) = AsyncStatus.Completed then
  begin
    LReadResult := LGattReadValueAsyncOp.GetResults;
    if LReadResult.Status = GenericAttributeProfile_GattCommunicationStatus.Success then
...
procedure TGattValueChangedEventHandler.Invoke(sender: GenericAttributeProfile_IGattCharacteristic; args: GenericAttributeProfile_IGattValueChangedEventArgs);
begin
...
procedure TBLEAdvertisementReceivedEventHandler.Invoke(sender: IBluetoothLEAdvertisementWatcher; args: IBluetoothLEAdvertisementReceivedEventArgs);
begin
  FAdapter.BLEAdvertisementReceived(args.Advertisement, args.AdvertisementType, args.BluetoothAddress, args.RawSignalStrengthInDBm, args.Timestamp);
end;
...
function TWinRTBluetoothLEAdvertiseData.DoAddServiceData(const AServiceUUID: TBluetoothUUID; const AData: TBytes): Boolean;
begin
...
begin
  if (FDevice <> nil) and (FDevice.AdvertisedData <> nil) then
    ...
    begin
      ...
      LServiceUUID := TBluetoothUUIDHelper.FromShortId(PWord(@LData[0])^);
...
function TWinRTBluetoothGattServer.DoAddCharacteristic(const AService: TBluetoothGattService; const ACharacteristic: TBluetoothGattCharacteristic): Boolean;
begin
  raise EBluetoothServiceException.Create(SBluetoothNotImplemented);
  Result := False;
end;
...
function TWinRTBluetoothGattServer.DoCreateCharacteristic(const AService: TBluetoothGattService; const AnUUID: TBluetoothUUID;
...
function TWinRTBluetoothGattServer.DoCreateDescriptor(const ACharacteristic: TBluetoothGattCharacteristic; const AnUUID: TBluetoothUUID)
...
function TWinRTBluetoothGattServer.DoCreateIncludedService(const AService: TBluetoothGattService; const AnUUID: TBluetoothUUID; AType: TBluetoothServiceType)
...
function TWinRTBluetoothGattServer.DoCreateService(const AnUUID: TBluetoothUUID; AType: TBluetoothServiceType): TBluetoothGattService;
begin
  raise EBluetoothServiceException.Create(SBluetoothNotImplemented);
  Result := nil;
end;
...
procedure TWinRTBluetoothGattServer.DoCharacteristicReadRequest(const ADevice: System.Bluetooth.TBluetoothLEDevice; ARequestId: integer; AnOffset: integer;
const AGattCharacteristic: TBluetoothGattCharacteristic);
begin
  // Not implemented
end;
...
const AGattCharacteristic: TBluetoothGattCharacteristic; APreparedWrite: Boolean; AResponseNeeded: Boolean; AnOffset: integer; const AValue: TBytes);
begin
  // Not implemented
end;
