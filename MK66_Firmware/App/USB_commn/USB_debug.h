...
//#define   USB_DEBUG_PRINT // Разрешаем отладочный вывод в процедурах USB

//#define _USB_DEBUG      Этот макрос разрешает отладочный вывод из более низких уровней стека USB, !!! Макрос объявляется в диалоге настроек IDE проекта
