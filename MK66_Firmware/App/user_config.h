...
#define MQX_CPU                 PSP_CPU_MK66FX180M
...
#define BSPCFG_ENABLE_RTCDEV     0  // Не разрешаем флаг часов реального времени поскольку иницализируем их в отдельной задаче
