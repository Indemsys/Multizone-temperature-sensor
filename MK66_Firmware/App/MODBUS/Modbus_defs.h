...
#define  MODBUS_STOP_1BIT                           UART_STOP_1BIT 
#define  MODBUS_STOP_2BIT                           UART_STOP_2BIT 


#define  MODBUS_PARITY_NONE                         UART_PARITY_NONE
#define  MODBUS_PARITY_ODD                          UART_PARITY_ODD
#define  MODBUS_PARITY_EVEN                         UART_PARITY_EVEN
